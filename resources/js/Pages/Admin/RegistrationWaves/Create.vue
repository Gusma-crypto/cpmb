...
const form = useForm({
    ...
    programs: props.programs.map((program) => ({
        ...
        name: program.name,
        code: program.code,
        status: program.is_active ? 'aktif' : 'nonaktif',
        is_open: true,
    })),
});
...
const submit = () => {
    form
        ...
        .post(route('admin.registration-waves.store'));
};
</script>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-2xl font-semibold text-gray-900">Tambah Gelombang</h1>
                ...
                <form class="space-y-6 overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg" @submit.prevent="submit">
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input v-model="form.label" type="text" placeholder="Gelombang 1" class="w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500" />
