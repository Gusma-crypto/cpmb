...
const submit = () => form.post(route('admin.question-categories.store'));
</script>

<template>
    <Head title="Tambah Kategori Soal" />

    <AdminLayout>
        <div class="py-8">
            <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-2xl font-semibold text-gray-900">Tambah Kategori Soal</h1>
