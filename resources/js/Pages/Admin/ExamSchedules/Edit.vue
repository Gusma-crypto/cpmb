...
const form = useForm({
    ...
    exam_type: props.schedule.exam_type,
    exam_date: props.schedule.exam_date?.slice(0, 10) || '',
    start_time: props.schedule.start_time,
    end_time: props.schedule.end_time,
    exam_time_slot_id: props.schedule.exam_time_slot_id || '',
    session_name: props.schedule.session_name,
    cbt_exam_id: props.schedule.cbt_exam_id || '',
...
const submit = () => form.put(routeName('update', props.schedule.id));
</script>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-2xl font-semibold text-gray-900">Edit Jadwal Ujian</h1>
